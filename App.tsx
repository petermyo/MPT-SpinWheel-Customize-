    ...
    <div className="h-screen bg-mpt-blue selection:bg-mpt-yellow selection:text-blue-900 text-white overflow-hidden flex flex-col">
      <nav className="z-40 bg-white/95 backdrop-blur-md shadow-lg py-3 px-6 flex items-center justify-between border-b-2 border-mpt-yellow shrink-0">
        ...
        <button 
          ...
          className="p-3 rounded-xl bg-gray-50 hover:bg-mpt-yellow/20 text-blue-900 transition-all active:scale-90 border border-gray-100"
        >
          {showAdmin ? <X size={24} /> : <Settings size={24} />}
        </button>
      </nav>
      ...
      <main className="flex-1 overflow-hidden p-4 grid grid-cols-1 lg:grid-cols-12 gap-6 max-w-[1600px] mx-auto w-full">
        ...
        <div className="lg:col-span-3 space-y-6 flex flex-col h-full overflow-hidden">
            <div className="bg-white/10 rounded-3xl p-6 border border-white/10 backdrop-blur-xl shadow-2xl flex-shrink-0">
                <div className="flex items-center gap-2 mb-4 text-mpt-yellow font-black uppercase tracking-widest text-xs">
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-3xl p-6 text-gray-800 shadow-2xl border-2 border-white/50 flex-1 overflow-auto custom-scrollbar">
                <h4 className="font-black text-mpt-blue mb-5 uppercase tracking-widest text-sm flex items-center gap-2 shrink-0">
                   <PartyPopper size={18} /> How to win
                </h4>
                <ul className="space-y-5">
                    <li className="flex gap-4 items-start">
                        <div className="bg-mpt-blue text-white w-7 h-7 rounded-lg flex items-center justify-center text-sm font-black shrink-0">1</div>
                        <p className="text-sm font-bold text-gray-600 leading-snug">Tap <span className="text-blue-900">TAP TO PLAY</span> to spin the fortune wheel.</p>
                    </li>
                    <li className="flex gap-4 items-start">
                        <div className="bg-mpt-blue text-white w-7 h-7 rounded-lg flex items-center justify-center text-sm font-black shrink-0">2</div>
                        <p className="text-sm font-bold text-gray-600 leading-snug">Wait for the pointer to land on your lucky reward.</p>
                    </li>
                    <li className="flex gap-4 items-start">
                        ...
                        <p className="text-sm font-bold text-gray-600 leading-snug">Your winning rewards are saved in the left panel!</p>
                    </li>
                </ul>
                <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                   <p className="text-[10px] font-black tracking-widest uppercase text-gray-400">© MPT Spin Wheel 2024</p>
                </div>
            </div>
        </div>
      </main>
      ...
      {showWinnerPopup && lastWin && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className="relative bg-white w-full max-w-sm rounded-[3rem] p-10 text-center shadow-2xl border-[8px] border-mpt-yellow animate-in zoom-in duration-300">
                ...
                <div className="mt-10 mb-6">
                    <h2 className="text-blue-900 font-black text-5xl tracking-tighter uppercase mb-3">CONGRATS!</h2>
                    
                    <div className="flex justify-center mb-5">
                      <div className="text-9xl leading-none transform hover:rotate-12 transition-transform cursor-pointer drop-shadow-xl">
                        {lastWin.icon}
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-50 py-5 px-4 rounded-3xl border-2 border-gray-100 shadow-inner">
                ...
                <button 
                    ...
                    className="w-full py-4 bg-mpt-yellow hover:bg-blue-900 hover:text-white text-blue-900 rounded-2xl font-black text-2xl uppercase tracking-tighter transition-all shadow-[0_5px_0_#B49400] active:translate-y-1 active:shadow-none"
                >
                    AWESOME!
                </button>
            </div>
